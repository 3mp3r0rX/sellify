...
const AdminDashboard: FC = () => {
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold py-5  mb-8">Admin Dashboard</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Link href="/admin/ads" legacyBehavior>
          <a className="bg-white p-4 rounded-xl shadow hover:bg-gray-200 transition">
        ...
        <Link href="/admin/reports" legacyBehavior>
          <a className="bg-white p-4 rounded-xl shadow hover:bg-gray-200 pb-10 transition">
